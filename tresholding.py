...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.aritmethicButton_2.setText(_translate("MainWindow", "Binary Inverse"))
        self.aritmethicButton_3.setText(_translate("MainWindow", "Truncate"))
        self.aritmethicButton_4.setText(_translate("MainWindow", "To Zero"))
        self.aritmethicButton_5.setText(_translate("MainWindow", "To Zero Inverse"))
